...
elements.nav.addEventListener("click", function () {
  ...
  if (resultsArr.length > 0) {
    ...
    const markup = `
      ...
      <li class="navigation__list--item navigation__item"><a href="https://s3.amazonaws.com/floresconsultinginc.com/index.html" target="_blank" class="navigation__link"><span>1</span>My Resume Hosted on AWS</a>
      <h2 class="navigation__list--item navigation__heading">Build Responsive Real World Websites with HTML5 and CSS3 - May 2018</h2>
      <li class="navigation__list--item navigation__item"><a href="omnifood/index.html" target="_blank" class="navigation__link"><span>2</span>Omnifood Website</a><a href="https://github.com/markfl/omnifood" target="_blank" class="navigation__github"><span>Source On Github</span></a></li>
      <h2 class="navigation__list--item navigation__heading">Advanced CSS and SASS: Flexbox, Grid, Animations and More - June 2018</h2>
      <li class="navigation__list--item navigation__item"><a href="natours/index.html" target="_blank" class="navigation__link"><span>3</span>Natours Website</a><a href="https://github.com/markfl/natours" target="_blank" class="navigation__github"><span>Source On Github</span></a></li>
      <li class="navigation__list--item navigation__item"><a href="trillo/index.html" target="_blank" class="navigation__link"><span>4</span>Trillo Website</a><a href="https://github.com/markfl/trillo" target="_blank" class="navigation__github"><span>Source On Github</span></a></li>
      <li class="navigation__list--item navigation__item"><a href="nexter/index.html" target="_blank" class="navigation__link"><span>5</span>Nexter Website</a><a href="https://github.com/markfl/nexter" target="_blank" class="navigation__github"><span>Source On Github</span></a></li>
      <h2 class="navigation__list--item navigation__heading">The Complete JavaScript Course 2018: Build Real Projects! - July 2018</h2>
      <li class="navigation__list--item navigation__item"><a href="dice-game/index.html" target="_blank" class="navigation__link"><span>6</span>Dice Game</a><a href="https://github.com/markfl/dice-game" target="_blank" class="navigation__github"><span>Source On Github</span></a></li>
      <li class="navigation__list--item navigation__item"><a href="budgety/index.html" target="_blank" class="navigation__link"><span>7</span>Budget</a><a href="https://github.com/markfl/budgety" target="_blank" class="navigation__github"><span>Source On Github</span></a></li>
      <li class="navigation__list--item navigation__item"><a href="forkify/dist/index.html" target="_blank" class="navigation__link"><span>8</span>Forkify</a><a href="https://github.com/markfl/forkify" target="_blank" class="navigation__github"><span>Source On Github</span></a></li>
		  <h2 class="navigation__list--item navigation__heading">Node.js, Express, MongoDB & More. The complete Bootcamp 2019 - July 2019</h2>
		  <li class="navigation__list--item navigation__item"><a href="https://natoursfci.herokuapp.com/" target="_blank" class="navigation__link"><span>9</span>Natours Server Version</a><a href="https://github.com/markfl/NatoursServer" target="_blank" class="navigation__github"><span>Source On Github</span></a></li>
		  ...
		  <li class="navigation__list--item navigation__item"><a href="https://github.com/markfl/CopyIFSToPC" target="_blank" class="navigation__link"><span>10</span>CopyIFSToPC</a></li>
      <li class="navigation__list--item navigation__item"><a href="https://github.com/markfl/RefundsReturns" target="_blank" class="navigation__link"><span>11</span>Refunds-Returns</a></li>
      <li class="navigation__list--item navigation__item"><a href="https://github.com/markfl/iSeriesSource" target="_blank" class="navigation__link"><span>12</span>Miscellaneous Source On iSeries</a></li>
      ...
      <li class="navigation__list--item navigation__item"><a href="concalc/dist/index.html" target="_blank" class="navigation__link"><span>13</span>Concersion Calculator</a><a href="https://github.com/markfl/concalcjavascript" target="_blank" class="navigation__github"><span>Source On Github</span></a></li>
